...
- Experiência em projetos utilizando Angular 12 ou superior.
- Consumo e integração de aplicações com REST API.
- Conhecimento em design de interface gráfica com HTML5 e CSS3.
...
- Arquitetura limpa de projetos front-end.
